...
function getCSSRules(styleSheets, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            styleSheets.forEach(function (sheet, sheetIdx) {
                        ...
                        (0, util_1.toArray)(sheet.cssRules || []).forEach(function (item, index) {
                            if (item.type === CSSRule.IMPORT_RULE) {
                                ...
                                var deferred = fetchCSS(url)
                                    ...
                                    .then(function (cssText) { return parseCSS(cssText); })
                                    .then(function (importedSheet) {
                                    (0, util_1.toArray)(importedSheet.cssRules)
                                        .map(function (rule) { return rule.cssText; })
                                        .forEach(function (ruleText) {
                                        try {
                                            sheet.insertRule(ruleText, ruleText.startsWith('@import')
                                                ? (importIndex_1 += 1)
