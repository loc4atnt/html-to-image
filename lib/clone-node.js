...
function cloneCSSStyle(nativeNode, clonedNode, options) {
    ...
    var manualAllStyle = options.allStyle;
    if (manualAllStyle) {
        Object.keys(manualAllStyle).forEach(function (key) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    exist = clone.querySelector(CSS.escape(id));
                    definition = document.querySelector(CSS.escape(id));
